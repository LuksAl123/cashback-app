...
export class HttpService {
  ...
  getCouponData(): Observable<any> {
    if (!this.sharedCouponData$) {
      console.log(
        'Creating shared observable - Preparing to fetch coupon data...'
      );
      ...
      this.sharedCouponData$ = this.http
        .post<any>(this.couponUrl, requestBody, { headers })
        .pipe(
          tap((response) => {
  ...
  sendVerificationCode(phone: string): Observable<any> {
    ...
    return this.http
      .post<any>(this.verificationCodeUrl, requestBody, { headers })
      .pipe(
        tap((response) => {
  ...
  recoverPassword(formValues: any): Observable<any> {
    ...
    return this.http
      .post<any>(this.recoverPasswordUrl, requestBody, { headers })
      .pipe(
        tap((response) => {
  ...
  activateCoupon(ncupom: string, idpessoa: number): Observable<any> {
    ...
    return this.http
      .post<any>(this.activateCouponUrl, requestBody, { headers })
      .pipe(
        tap((response) => {
  ...
  getPeopleBalance(idpessoa: number): Observable<any> {
    ...
    return this.http
      .post<any>(this.getRelatoriosUrl, requestBody, { headers })
      .pipe(
        tap((response) => {
  ...
  sendEmail(email: string): Observable<any> {
    ...
    return this.http
      ...
      .pipe(
        tap((response) => {
          console.log('Verification code sent successfully:', response);
          this.verificationCode = response.detalhe.codigovalidacaoemail;
        }),
        retry({
          count: 2,
          delay: 1000,
  ...
  changeEmail(email: string): Observable<any> {
    ...
    const requestBody = {
      ...
      email: email,
      telefone: this.userService.getPhone(),
    };
    ...
    return this.http
      ...
      .pipe(
        tap((response) => {
          ...
          console.log(response.detalhe.email);
          this.userService.setEmail(response.detalhe.email);
        }),
        retry({
          count: 2,
          delay: 1000,
